			...
			<?php foreach ($testimonials as $testimonial) {	
				...
				if(!empty($testimonial['author']) && !empty($testimonial['text'])) {
					...
					if(!empty($testimonial['link'])) {
						...
						$author = '<span class="author">'. do_shortcode(htmlspecialchars_decode($testimonial['author'])).'</span>';
					}
					...
					<div class="testimonial-before"></div>
						...
						<?php if($show_author_on_top == 1){ ?>
							...
							<div class="testimonial-texts">
								<i class="fa fa-quote-right"></i><div class="testi-text"><?php echo do_shortcode(htmlspecialchars_decode($testimonial['text'])) ?></div><i class="fa fa-quote-right"></i>
							</div>
