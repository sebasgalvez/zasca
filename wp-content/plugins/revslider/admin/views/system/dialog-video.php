	...
	<form name="video_dialog_form" onkeypress="return event.keyCode != 13;">
		...
		<div id="rs-video-source">
			...
			<div id="video_block_vimeo" class="video-select-block" style="display:none;" >
				...
				<input type="button" style="vertical-align:middle" id="button_vimeo_search" class="button-regular video_search_button" value="buscar">
			...
			<div id="video_block_youtube" class="video-select-block">
				...
				<input type="button" style="vertical-align:middle" id="button_youtube_search" class="button-regular video_search_button" value="buscar">
